...
**Effective as of the date of the first Contribution to this Project.**

## 1. Definitions

- **"You"** or **"Your"** means the copyright owner who makes a Contribution to this Project.
- **"Contribution"** means any work of authorship, including but not limited to code, documentation, bugs, issues, and suggestions that you submit to this Project.
- **"Project Owner"** means the individual or entity identified in the repository's main page as the owner and maintainer of this Project.
- **"This Project"** means the repository and all related materials where this CLA is present.
...
## 5. THIS CLA IS PROVIDED "AS IS"

Except as explicitly stated in this CLA, Your Contributions are provided "AS IS" without warranty of any kind, either express or implied.
...
By submitting a Contribution to this Project (including via pull request, issue, comment, or any other method), you agree to the terms of this CLA.

For corporate Contributors: if you are submitting Contributions on behalf of an employer, your employer is deemed to have accepted this CLA on your behalf.

For questions about this CLA, contact the Project Owner directly.